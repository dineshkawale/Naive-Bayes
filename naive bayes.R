...
salary_train <- read.csv("C:/Users/DINESH/Desktop/SalaryData_Train.csv") #This data is used to train the Model
attach(salary_train)

salary_test <- read.csv("C:/Users/DINESH/Desktop/SalaryData_Test.csv") #This data is used to Test the Model
attach(salary_test)
